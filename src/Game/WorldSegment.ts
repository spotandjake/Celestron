...
export const generateWorldSegment = (
  ...
  if (segmentType.canSpawn && !segmentType!.canSpawn(x, y, side, worldSegmentList)) return false;
  // Make New Cell
  const cell = {
    x: x,
    y: y,
...
export const segmentTypeList: WorldSegment[] = [
  {
    ...
    paths: [
      {
        points: [new Vector(width / 2, height), new Vector(width / 2, height * 0.75)],
        pathSides: new Set([Side.Bottom]),
      },
    ],
    decorations: [
      {
  ...
  },
  {
    ...
    paths: [
      {
        points: [new Vector(width / 2, height), new Vector(width / 2, 0)],
        pathSides: new Set([Side.Top, Side.Bottom]),
      },
    ],
    decorations: [
      {
    ...
    freeSide: new Set([Side.Top, Side.Bottom]),
  },
  {
    width: width,
    height: height,
    ...
    paths: [
      {
        points: [new Vector(0, height / 2), new Vector(width, height / 2)],
        pathSides: new Set([Side.Right, Side.Left]),
      },
    ],
    decorations: [
      {
    ...
    freeSide: new Set([Side.Right, Side.Left]),
  },
  {
    width: width,
    height: height,
    ...
    paths: [
      {
        ...
        pathSides: new Set([Side.Top, Side.Left]),
      },
    ],
    decorations: [
      {
    ...
    freeSide: new Set([Side.Top, Side.Left]),
  },
  {
    width: width,
    height: height,
    ...
    paths: [
      {
        ...
        pathSides: new Set([Side.Right, Side.Top]),
      },
    ],
    decorations: [
      {
    ...
    freeSide: new Set([Side.Right, Side.Top]),
  },
  {
    width: width,
    height: height,
    ...
    paths: [
      {
        ...
        pathSides: new Set([Side.Bottom, Side.Left]),
      },
    ],
    decorations: [
      {
    ...
    freeSide: new Set([Side.Bottom, Side.Left]),
  },
  {
    width: width,
    height: height,
    ...
    paths: [
      {
        ...
        pathSides: new Set([Side.Bottom, Side.Right]),
      },
    ],
    decorations: [
      {
    ...
    freeSide: new Set([Side.Bottom, Side.Right]),
  },
  // {
  //   width: width,
  //   height: height,
