...
export const Dialog: { [key: number]: Message[] } = {
  0: [
    ...
    },
    {
      ...
      name: 'TheDrone7',
      message:
        'Your job is to take out all the malicious repls that appear such as ToS-violating repls, malicious, attacks, etc.',
    },
    {
      image: 'r-lily.png',
      name: 'Lily',
  ...
  1: [
    ...
    },
    {
      ...
      name: 'TheDrone7',
      message:
        'Sweet! here are some more on the way, slightly harder to deal with, but I\'m sure you\'ll be able to handle them.',
    },
  ],
  4: [
    {
    ...
    },
    {
      ...
      name: 'Piero',
      message:
        'See how fast you can take them out.  If you do it fast enough, I\'ll give you the best piero pic.',
    },
  ],
  6: [
    {
  ...
  8: [
    ...
    },
    {
      ...
      name: 'Bookie',
      message:
        'What in the world is this design, piero?  Liek come on man wtf, take a look at this abomidable layout and interface!',
    },
    {
      image: 'r-bookie.png',
      name: 'Bookie',
  ...
  10: [
    ...
    },
    {
      ...
      name: 'AllAwesome497',
      message:
        'I\'m seeing some activity outside of replit HQ.  Not sure exactly what it is.  By the way, replit editors are having a lot of bugs.  Could you fix that up for us?',
    },
  ],
  14: [
    {
    ...
    },
    {
      ...
      name: 'Soren',
      message:
        'Any experience with search engine algorithms?  I need you to patch up some issues here.',
    },
    {
  ...
  16: [
    {
      ...
      name: 'Dart',
      message:
        'There have been an unnatural increase in nitro scammers.  Take a look out for those.',
    },
    {
      image: 'r-h.png',
      name: 'TheDrone7',
      message:
        'Looks like some replit bot accounts are increasing and running for malicious purposes.  Be sure to take care of them.',
    },
    {
      image: 'r-jdog.png',
      name: 'JDOG787',
    ...
    },
    {
      ...
      name: 'TheDevBird',
      message:
        'Remember, we seek pain when we can.  Assuming this isn\'t that much of a load, lemme give you another list of stuff to be fixed.',
    },
  ],
  17: [
    {
    ...
    },
    {
      ...
      name: 'AllAwesome497',
      message:
        'Even from a birds-eye view, I\'m not able to identify this large wave of activity moving towards the HQ.',
    },
    {
      image: 'r-devbird.png',
      name: 'TheDevBird',
    ...
    },
    {
      ...
      name: 'TheDevBird',
      message:
        'Hmmm, looks like it\'s getting closer at a constant speed, possibly shielded from view with some special technology.',
    },
    {
      image: 'r-amasad.png',
      name: 'Amjad',
      message:
        'I\'ll figure out a way to break the formation.  Keep the base safe for me.  I got some CEO stuff to do.',
    },
  ],
  19: [
    {
    ...
    },
    {
      ...
      name: 'Amjad',
      message:
        'Even with nix on our side, I\'m not fully able to reveal it and there also is a low chance of destroying it.',
    },
    {
      image: 'r-spotandjake.png',
      name: 'SpotAndJake',
  ...
  24: [
    ...
    },
    {
      ...
      name: 'Soren',
      message:
        'Verified, we are undergoing an attack right now.  Keep the base safe at all costs, lots of things are gettins insecure.',
    },
    {
      image: 'r-aa.png',
      name: 'AllAwesome497',
      message:
        'Invasion force is coming nearer and could be transmitting a wireless attack.  The force is going to arrive any moment now.',
    },
  ],
  26: [
    {
      ...
      name: 'Cnnd',
      message:
        'At least discord works.  Sheesh, there are a lot of people I\'m having to warn about pinging the team about downtime issues.',
    },
    {
      image: 'r-bookie.png',
      name: 'Bookie',
    ...
    },
    {
      ...
      name: 'Lily',
      message:
        'Everyone, we got some issues, please check out https://status.replit.com for more information.',
    },
    {
      image: 'r-aa.png',
      name: 'AllAwesome497',
      message:
        'We\'re almost done fixing things from the ongoing attack.  Just keep us alive a little bit longer.',
    },
  ],
  28: [
    {
      ...
      name: 'AllAwesome497',
      message:
        'We\'ve just about finished taking care of those DDoS attacks.  Also, good news for pain seekers: the invasion force is here.',
    },
    {
      image: 'r-frissyn.png',
      name: 'Frissyn',
    ...
    },
    {
      ...
      name: 'Amjad',
      message:
        'We\'re all in this together.  We\'ll survive this if we can put our full force together.',
    },
  ],
  29: [
    {
    ...
    },
    {
      ...
      name: 'SpotAndJake',
      message:
        'Congratgulations, player!  I hope you liked our game!  Be sure to give us an upvote if you\'re liked it!',
    },
    {
      image: 'r-ironclad.png',
      name: 'IroncladDev',
  ...
  100: [
    {
      ...
      name: 'Amasad',
      message:
        'Wave 100.  I\'m glad you\'re still defending us.  Time to make a tweet about our guardian ^_^',
    },
  ],
};
// Store Data
